// dnSpy decompiler from Assembly-CSharp.dll class: CharacterMotor
using System;
using UnityEngine;
...
public class CharacterMotor : MonoBehaviour
{
	...
	public float CalculateAltitude()
	{
		int num = 772;
		num = ~num;
		Vector3 vector = base.transform.position + base.transform.localToWorldMatrix.MultiplyVector(this.controller.center);
	...
	private void UpdateFunction()
	{
		...
		if (PlayerManager.Instance != null && PlayerManager.Instance.LocalPlayer.IsDead)
		{
			return;
		}
