...
namespace Obfuscator.Gui
{
    public class SettingsWindow : EditorWindow
    {
        ...
        private void AdvancedTab()
        {
            ...
            Table.GuiLastGold("Obfuscate:", "Private", "Protected", "Public", ref this.settings.ObfuscateFieldPrivate, ref this.settings.ObfuscateFieldProtected, ref this.settings.ObfuscateFieldPublic);
            ...
            Table.GuiLastGold("Obfuscate:", "Private", "Protected", "Public", ref this.settings.ObfuscateMethodPrivate, ref this.settings.ObfuscateMethodProtected, ref this.settings.ObfuscateMethodPublic);
